    ...
    <div className="bg-[#050510] dark:bg-[#0A0A0A] light:bg-[#F8F9FA] pt-32 transition-colors duration-300">
      <section className="py-20 px-6 lg:px-12 max-w-[1800px] mx-auto">
        <div className="max-w-3xl mb-20">
          <h1 className="text-5xl md:text-7xl font-medium text-white dark:text-white light:text-black mb-8 transition-colors uppercase tracking-tighter">Our Work Speaks for Itself</h1>
        ...
        <div className="mt-32 text-center">
          <h2 className="text-3xl font-medium text-white dark:text-white light:text-black mb-8 transition-colors">Ready to be our next success story?</h2>
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a href="/contact" className="px-8 py-4 rounded-full bg-white/10 dark:bg-white/10 light:bg-black/10 text-white dark:text-white light:text-black font-medium hover:scale-105 transition-transform transition-colors">Let’s Create Yours</a>
          </div>
        </div>
      </section>
    </div>
